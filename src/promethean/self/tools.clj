(ns promethean.self.tools
  (:require [promethean.tool :refer [def-tool]]
            [promethean.proto :as proto]))

(proto/def-proto proto/self-tool
  {:mixins [proto/mixin-trace]
   :defaults {}
   :hooks {:before [] :after [] :around []}})

(def-tool self.set_desire
  {:proto proto/self-tool
...
(def-tool self.remove_aspiration
  {:proto proto/self-tool
   ...
   :inputSchema {:type "object"
                 ...
                 :required []}}
  (fn [_ctx args]
    {:action "remove_aspiration"
     :aspiration (get args "aspiration")
     :remove_all (get args "remove_all")
     :removed_at (System/currentTimeMillis)}))

(def-tool self.remove_goal
  {:proto proto/self-tool
